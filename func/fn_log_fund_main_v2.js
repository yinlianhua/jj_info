...
const fn_log_fund_main_v2 = async (codes=[], date="") => {
    ...
    for (let [key, infos] of Object.entries(main_list)) {
        ...
        for (let elem of infos.reverse()) {
            ...
            let f_min180 = chalk[c_min180](elem.min180);
            let f_min210 = chalk[c_min210](elem.min210);
            ...
            let f_max180 = chalk[c_max180](elem.max180);
            let f_max210 = chalk[c_max210](elem.max210);
            ...
            let f_r180   = chalk[c_180](r_180);
            let f_r210   = chalk[c_210](r_210);
